...
| Limite típico de armazenamento | Cerca de 4 KB por cookie | Cerca de 5 MB por origem (varia conforme o navegador) | Cerca de 5 MB por origem (varia conforme o navegador) |
