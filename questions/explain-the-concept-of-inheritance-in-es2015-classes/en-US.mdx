...
```mermaid
---
title: Instance and constructor inheritance with extends
---
flowchart LR
  DogInstance["new Dog()"] -->|"[[Prototype]]"| DogProto["Dog.prototype"]
  DogProto -->|"[[Prototype]]"| AnimalProto["Animal.prototype"]
  AnimalProto -->|"[[Prototype]]"| ObjectProto["Object.prototype"]
  DogCtor["Dog constructor"] -->|"[[Prototype]]"| AnimalCtor["Animal constructor"]
  AnimalCtor -->|"[[Prototype]]"| FunctionProto["Function.prototype"]
```
