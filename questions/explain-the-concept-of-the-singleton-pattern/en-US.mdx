...
```mermaid
---
title: Singleton instance ownership
---
flowchart TD
  Owner["Module registry or dependency container"] --> Create{"Instance already created?"}
  Create -->|"No"| Instance["Create and retain one instance"]
  Create -->|"Yes"| Instance
  Instance --> ConsumerA["Consumer A"]
  Instance --> ConsumerB["Consumer B"]
  Instance --> ConsumerC["Consumer C"]
```
