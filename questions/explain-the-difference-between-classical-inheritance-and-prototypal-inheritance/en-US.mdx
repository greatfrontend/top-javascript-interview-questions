...
```mermaid
---
title: Classical and prototypal inheritance models
---
flowchart LR
  subgraph Classical["Class-oriented model"]
    Superclass["Superclass"] -->|"extended by"| Subclass["Subclass"]
    Subclass -->|"instantiates"| Instance["Instance"]
  end
  subgraph Prototypal["Prototype-oriented model"]
    Child["Child object"] -->|"[[Prototype]] delegation"| Parent["Prototype object"]
    Parent -->|"[[Prototype]] delegation"| Root["Another prototype or null"]
  end
```
