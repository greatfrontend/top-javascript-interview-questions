...
```mermaid
---
title: Global, function, and block scope nesting
---
flowchart TD
  Global["Global scope"] --> Function["Function scope"]
  Function --> Block["Block scope"]
  Global --> GlobalBinding["global binding"]
  Function --> FunctionBinding["var and function-local bindings"]
  Block --> BlockBinding["let, const, and class bindings"]
  Block -. "can resolve outward" .-> FunctionBinding
  Block -. "can resolve outward" .-> GlobalBinding
  Global -. "cannot resolve inward" .-> BlockBinding
```
