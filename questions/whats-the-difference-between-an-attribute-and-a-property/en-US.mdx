...
```mermaid
---
title: HTML attributes and DOM properties
---
flowchart LR
  Markup["HTML markup attribute"] --> Parser["HTML parser"]
  Parser --> Attribute["Element attribute value, usually a string"]
  Parser --> Property["Initial DOM property state"]
  Attribute <-->|"only for reflected pairs"| Property
  Script["JavaScript interaction"] --> Property
  Property --> Live["Current element behavior or state"]
```
...
- [MDN Web Docs: Content versus IDL attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes#content_versus_idl_attributes)
